...
О: Да, поэтому не давайте его никому

**В: Можно отозвать старый access token?**
О: Да, для этого сгенерируйте новый или смените пароль аккаунта

**В: Знаю ли я ваш access token?**
О: Нет, вы получаете его на странице Вконтакте (убедитесь в этом по адресной строке браузера). У меня нет возможности поставить свой счетчик на сайт Вконтакте. Я знаю только количество переходов по ссылке.

## Шаг 0. Залогиньтесь

Откройте Вконтакте <a href="https://vk.com/" title="Вконтакте откроется в новом окне" target="_blank">по ссылке</a>, что вы залогинены в нужном аккаунте Вконтакте. 
