...
Пройдите по ссылке на [страницу авторизации Вконтакте](https://oauth.vk.com/authorize?client_id={{ page.app_id }}&display=popup&scope={{ page.scope }}&response_type=code&v=5.103&redirect_uri={{ site.url }}{{ page.url }}){#link} и нажмите кнопку "Разрешить"
...
Пройдите по ссылке <a id="link1" href="">вторая ссылка</a>
